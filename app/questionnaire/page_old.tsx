...
const profileSchema = z.object({
  ...
  linkedinUrl: z.string().min(1, 'LinkedIn URL is required').refine((url) => {
...
export default function QuestionnairePage() {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      localStorage.removeItem('profileFormData'); // Clear saved data
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800">
                    <strong>Almost done!</strong> Click "Complete Profile" below to save your information and start finding referrals.
                  </p>
                </div>
              </div>
            )}
